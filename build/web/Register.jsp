<%-- 
    Document   : Register
    Created on : Mar 22, 2022, 4:02:56 PM
    Author     : admin
--%>
...
<html>
    ...
    <div class="signup__container" style="width: 100%;height: 60%;">
            <div class="container__child signup__thumbnail">
                ...
                <div class="thumbnail__content text-center" style="margin-top: 90px; margin-left: 19%;">
            ...
            <div class="container__child signup__form">
                <form action="ControllerAccount" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="username" id="username" placeholder="${ab}" required />
                    </div>
                     </c:if>
                    <c:if test="${ab==null}">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="passwordRepeat">Repeat Password</label>
                        <input class="form-control" type="password" name="passwordRepeat" id="passwordRepeat" placeholder="${err}" required />
                    </div>
                    </c:if>
                    <div class="m-t-lg">
    ...
    <style type="text/css">
        ...
        .signup__thumbnail {
            ...
            flex-wrap: wrap;
            align-items: center;
            background: url(https://vtv1.mediacdn.vn/thumb_w/650/2015/spectre1-1424836031313-crop-1424836045496.jpg);
