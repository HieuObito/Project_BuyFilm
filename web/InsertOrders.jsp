                    ...
                    <div class="row">
                        <div> 
                            <div class="cart-table-wrap">
                                <form action="ControllerAdmin" method="post" style="padding-bottom: 100px; padding-top: 50px;">
                                    <input type="hidden" name="do" value="insertO">
                                    <table class="table" >                                    
                                        <tr>
                                            <th style="padding-top: 16px;">Customer ID</th>
                                            <td>
                                                <input value="" type="text" name="cid">
                                            </td>
                                        </tr>
                                        <tr>
