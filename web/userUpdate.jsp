                    ...
                    <div class="row">
                        <div> <!--class="col-lg-12 col-md-12"-->
                            ...
                            <form action="ControllerAdmin" method="get" style="padding-bottom: 100px; padding-top: 50px;">
                                ...
                                <table class="table">                                    
                                    <tr>
                                        <th style="padding-top: 16px;">CustomerID</th>
                                        <td>
                                            <input value="<%=rs.getInt(1)%>" type="text" name="id" readonly>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="padding-top: 16px;">CustomerName</th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input value="<%=rs.getString(3)%>" type="text" name="country" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="padding-top: 16px;">Gmail</th>
                                        <td>
                                            <input value="<%=rs.getString(4)%>" type="text" name="gmail">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="padding-top: 16px;">user</th>
                                        <td>
                                            <input value="<%=rs.getString(5)%>" type="text" name="user">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="padding-top: 16px;">password</th>
                                        <td>
                                            <input value="<%=rs.getString(6)%>" type="text" name="pass">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
